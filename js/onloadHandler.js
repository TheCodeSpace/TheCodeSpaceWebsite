loadScriptRedirect("api/householdHandler.js", function() {
	...
	if (check == true) {
		if (confirm("This webpage is not optimized for mobile devices and tablets.") || !confirm("This webpage is not optimized for mobile devices and tablets.")) {
			location.href = "com.google";
		}
	}
